...
export const ALL_TAGS: TagOrSeparator[] = [
  ...
  },
  {
    ...
    calloutKey: `${ACTIVE_TAG_KEY_TASK}:Discuss`,
  },
  {
    ...
    calloutKey: `${ACTIVE_TAG_KEY_TASK}:Discuss with manager`,
  },
  {
    label: 'Send in email',
    icon: <EmailTagIcon />,
    ...
    calloutKey: `${ACTIVE_TAG_KEY_TASK}:Send in email`,
  },
  {
    ...
    calloutKey: `${ACTIVE_TAG_KEY_TASK}:Schedule meeting`,
  },
  {
    label: 'Call back',
    icon: <ChecklistTagIcon fill={TAG_FILL_TODO_BLUE} />,
    ...
    calloutKey: `${ACTIVE_TAG_KEY_TASK}:Call back`,
  },
  {
    ...
    calloutKey: `${ACTIVE_TAG_KEY_TASK}:P1`,
  },
  {
    ...
    calloutKey: `${ACTIVE_TAG_KEY_TASK}:P2`,
  },
