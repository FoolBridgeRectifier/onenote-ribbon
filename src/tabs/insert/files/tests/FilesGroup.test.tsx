...
describe("FilesGroup — integration", () => {
  it.skip("renders Attach File and Embed Note buttons", () => {
  ...
  it.skip("Attach File inserts ![[]] at cursor", () => {
  ...
  it.skip("Embed Note inserts ![[]] at cursor", () => {
    const { app, editor } = createAppWithEditor("");
    editor.setCursor({ line: 0, ch: 0 });
    renderWithApp(<FilesGroup />, app);
  ...
  it.skip("Attach File appends at non-zero cursor", () => {
  ...
  it.skip("Attach File is no-op when no active editor", () => {
  ...
  it.skip("Embed Note is no-op when no active editor", () => {
    const app = createMockApp();
    renderWithApp(<FilesGroup />, app);
