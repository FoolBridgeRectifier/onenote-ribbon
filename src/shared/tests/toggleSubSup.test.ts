...
describe("toggleSubSup — Subscript (<sub>)", () => {
  ...
  it("inserts empty <sub></sub> pair at cursor when no selection", () => {
    const e = new MockEditor();
    e.setValue("hello");
  ...
  it("toggles off when cursor is inside <sub>…</sub>", () => {
    const e = new MockEditor();
  ...
  it("converts <sup> to <sub> (mutual exclusion)", () => {
    const e = new MockEditor();
  ...
  it("does NOT toggle off when cursor is at tag boundary (ch at `>` of opening tag)", () => {
  ...
  it("does not affect a sub span when cursor is outside it", () => {
    const e = new MockEditor();
...
describe("toggleSubSup — Superscript (<sup>)", () => {
  ...
  it("inserts empty <sup></sup> pair at cursor when no selection", () => {
    const e = new MockEditor();
    e.setValue("hello");
    e.setCursor({ line: 0, ch: 5 });
    toggleSubSup(e, "sup");
  ...
  it("toggles off when cursor is inside <sup>…</sup>", () => {
    const e = new MockEditor();
    e.setValue("x<sup>3</sup>");
    e.setCursor({ line: 0, ch: 7 }); // inside "3"
    toggleSubSup(e, "sup");
  ...
  it("converts <sub> to <sup> (mutual exclusion)", () => {
    const e = new MockEditor();
    e.setValue("x<sub>2</sub>");
    e.setCursor({ line: 0, ch: 7 }); // inside "2"
    toggleSubSup(e, "sup");
  ...
  it("does not affect a sup span when cursor is outside it", () => {
    const e = new MockEditor();
