...
export const CSS_PROPERTY_TO_TAG_TYPE: Record<string, string> = {
  color: 'color',
  'font-size': 'fontSize',
...
export const PROTECTED_TOKEN_RECOGNISERS: ReadonlyArray<{
  pattern: RegExp;
  tokenType: string;
}> = [
...
export const HTML_TAG_RECOGNISERS: ReadonlyArray<{ name: string; type: string }> = [
...
export const MD_DELIMITER_RECOGNISERS: ReadonlyArray<{ delimiter: string; type: string }> = [
  { delimiter: '**', type: 'bold' },
