 ...
 */
export const MD_DELIMITER_FOR_TYPE: Partial<Record<string, string>> = {
  bold: '**',
  italic: '*',
  strikethrough: '~~',
  highlight: '==',
...
export const HTML_ELEMENT_FOR_TYPE: Partial<Record<string, string>> = {
  bold: 'b',
  italic: 'i',
  strikethrough: 's',
  underline: 'u',
...
export const CSS_PROPERTY_FOR_SPAN_TYPE: Partial<Record<string, string>> = {
  color: 'color',
  fontSize: 'font-size',
...
export const DEFAULT_SPAN_VALUE: Partial<Record<string, string>> = {
  color: '#ff0000',
  fontSize: '14pt',
  fontFamily: 'Arial',
  highlight: '#ffff00',
...
/** Maps string to its mutual-exclusion partner (subscript ↔ superscript). */
...
export const EMPTY_REPLACEMENTS: never[] = [];
